...
export function getNodeAutoInstrumentations(inputConfigs: InstrumentationConfigMap = {}): Instrumentation[] {
...
export function getResourceDetectorsFromEnv(): Array<Detector | DetectorSync> {
  const resourceDetectors = new Map<string, Detector | DetectorSync | Detector[]>([
    ...
    [RESOURCE_DETECTOR_AWS, [awsEc2Detector, awsEcsDetector, awsEksDetector, awsBeanstalkDetector, awsLambdaDetector]],
  ]);
